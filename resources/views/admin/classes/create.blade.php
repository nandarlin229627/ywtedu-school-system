...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Create New Class</h1>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-body p-4 p-md-5">
            <form method="POST" action="{{ route('admin.classes.store') }}" autocomplete="off">
                @csrf
                ...
                <div class="d-flex justify-content-end gap-2 mt-5 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-success px-4 rounded-3 fw-medium d-inline-flex align-items-center">
                        <i class="fas fa-check me-2"></i> Save Class
                    </button>
                </div>
            </form>
        </div>
