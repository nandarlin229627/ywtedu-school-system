...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-body p-4 p-md-5">
            <form method="POST" action="{{ route('admin.subjects.store') }}" autocomplete="off">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text text-muted small mt-1">
                        Give this subject a clear, unique title that students or teachers will recognize.
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-5 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-success px-4 rounded-3 fw-medium d-inline-flex align-items-center">
                        <i class="fas fa-check me-2"></i> Save Subject
                    </button>
                </div>
            </form>
        </div>
